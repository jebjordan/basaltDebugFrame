...
function(bc,cc)
bc=bc or db()
--print(bc, require('cc.pretty').pretty(bc))
...
setmetatable(db,cb)end end;aa["libraries"]={}
...
ac:addForegroundBox(1,1,bc,cc,db)end end end,2)end}return _c end}end;return aa["main"]()